...
const Repair_form = () => {
    ...
    return (
        ...
        <form className="w-full max-w-lg mx-auto p-5 mt-5 bg-white rounded-lg shadow-lg" onSubmit={handleSubmit}>
        <h1 className="text-2xl font-bold text-center mb-6">Submit Repair Request</h1>
